# DisplayName: Jolla espressowifi/@ARCH@ (release) 1
...
repo --name=adaptation-community-common-espressowifi-@RELEASE@ --baseurl=http://repo.merproject.org/obs/nemo:/devel:/hw:/common/sailfish_latest_@ARCH@/
...
%packages
@Jolla Configuration espressowifi
%end

%attachment
### Commands from /tmp/sandbox/usr/share/ssu/kickstart/attachment/espressowifi
